...
<head>
    ...
    <title>429 Estás yendo demasiado rápido</title>
...
<body class="bg-[#FDFDFC] text-[#1b1b18]">
    ...
    <main class="min-h-screen bg-zinc-100 flex flex-col justify-center items-center text-center p-10">
        ...
        <h1 class="text-5xl font-extrabold text-tamarillo-600 mb-4">🚦 429 - Demasiadas Solicitudes</h1>
        <p class="text-gray-600 text-lg mb-6">Has realizado demasiadas solicitudes en poco tiempo.
            Para proteger nuestros sistemas, debes esperar un momento antes de volver a intentarlo.
        </p>
