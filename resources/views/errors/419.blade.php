...
<head>
    ...
    <title>419 Tu sesión ha caducado</title>
...
<body class="bg-[#FDFDFC] text-[#1b1b18]">
    ...
    <main class="min-h-screen bg-zinc-100 flex flex-col justify-center items-center text-center p-10">
        ...
        <h1 class="text-5xl font-extrabold text-tamarillo-600 mb-4">⏳ 419 - Sesión Expirada</h1>
        <p class="text-gray-600 text-lg mb-6">Por motivos de seguridad, tu sesión ha expirado.
            Por favor, vuelve a iniciar sesión y continúa donde lo dejaste.
        </p>
