...
<head>
    ...
    <title>500 Algo salió mal en nuestro sistema</title>
...
<body class="bg-[#FDFDFC] text-[#1b1b18]">
    ...
    <main class="min-h-screen bg-zinc-100 flex flex-col justify-center items-center text-center p-10">
        ...
        <h1 class="text-5xl font-extrabold text-tamarillo-600 mb-4">🔥 500 - Error interno del servidor</h1>
        <p class="text-gray-600 text-lg mb-6">Lo sentimos, ha ocurrido un error inesperado en nuestros servidores.
            Nuestro equipo ya está trabajando para solucionarlo lo antes posible.
            Puedes intentar recargar la página más tarde.</p>
