...
<section class="w-full">
    ...
    <x-settings.layout :heading="__('Actualiza tu contraseña')" :subheading="__('Asegúrese de que su cuenta utiliza una contraseña larga y aleatoria para mantener la seguridad')">
