<div>
    <flux:modal name="nuevo-donante" class="md:w-96">
        <div class="space-y-6">
            <div>
                <flux:heading size="lg">Crear un nuevo donante</flux:heading>
                <flux:text class="mt-2">Rellena los campos con los datos personales de donantes.</flux:text>
            </div>
